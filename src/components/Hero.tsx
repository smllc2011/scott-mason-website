      ...
      <div className="container-site relative grid items-center gap-5 pb-4 pt-[calc(var(--site-header-height)+2rem)] lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:gap-x-10 lg:pb-5 lg:pt-[calc(var(--site-header-height)+2.5rem)] xl:gap-x-12 xl:pt-[calc(var(--site-header-height)+3rem)]">
        <div className="min-w-0">
          <div className="relative max-w-full">
            ...
            <div className="relative animate-in flex min-w-0 flex-col gap-4 sm:gap-5 lg:gap-6">
              <h1 className="heading-hero flex w-full max-w-full flex-col gap-1.5 sm:gap-2 text-white lg:max-w-[94%]">
              ...
              <div
                className="h-[2px] w-[100px] rounded-full bg-[linear-gradient(90deg,transparent_0%,var(--color-accent)_15%,var(--color-accent)_85%,transparent_100%)]"
                aria-hidden="true"
              />
